...
#| fig-cap: Country locations of IHTM students for the past 10 years
...
leaflet::leaflet() |>
  ...
  leaflet::addCircleMarkers(
    data = map_data(),
    radius = 5,
    fillColor = oxthema::get_oxford_colour("royal"),
    weight = 1,
    opacity = 1,
    color = oxthema::get_oxford_colour("royal"),
    fillOpacity = 0.6,
    ...
    labelOptions = leaflet::labelOptions(
      style = list(
        "font-weight" = "bold",
        "background-color" = oxthema::get_oxford_colour("cool"),
        padding = "3px 8px"
      ),
      textsize = "12px",
      direction = "auto"
